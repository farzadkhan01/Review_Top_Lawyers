...
import { ScaleIcon, MapPinIcon, StarIcon, UsersIcon } from "@/components/ui/icons";
...
const FEATURES = [
  ...
  },
  {
    ...
    description: "Narrow your search by location to find lawyers who serve your area.",
  },
  {
    icon: StarIcon,
    title: "Read Ratings & Reviews",
    description: "Compare ratings and reviews to understand what past clients experienced.",
  },
  {
    icon: UsersIcon,
          ...
          {FEATURES.map((feature, index) => (
            <Reveal key={feature.title} delay={index * 0.05}>
              <div className="flex flex-col gap-3">
                ...
                <p className="text-sm leading-relaxed text-muted-600">{feature.description}</p>
              </div>
            </Reveal>
          ))}
        </div>
