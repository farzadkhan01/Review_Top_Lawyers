...
export default function RankingSection() {
  const rankedLawyers = [...lawyers].sort((a, b) => b.reviewCount - a.reviewCount).slice(0, 5);
    ...
    <section className="bg-white py-20 sm:py-24">
      <Container className="flex flex-col gap-10">
        <SectionHeading
          ...
          description="These lawyers currently have the most reviews in our demo directory. This reflects activity within Review Top Lawyers only, not an independent or verified ranking."
        />
              ...
              <Reveal delay={index * 0.05}>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="truncate font-semibold text-navy-900">{lawyer.name}</p>
        ...
        <Button href="/directory?sort=reviews" variant="secondary" className="self-start">
          View Full Rankings
        </Button>
      </Container>
    </section>
